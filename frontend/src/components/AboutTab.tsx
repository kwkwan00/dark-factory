...
const SYSTEM_NODES: Node[] = [
  makeNode(
    "spa",
    <Label lines={["React SPA (Vite)", "6 tabs"]} />,
    260,
    0,
    "ui",
    { width: 180 },
  ...
  return (
    <div>
      ...
      >
        ...
        <FactTable
          rows={[
            ["Author", "Kevin Quon <kquon@nvisia.com>"],
      ...
      >
        ...
        <FactTable
          rows={[
            ...
            [
              "Run history + replay",
              "Every run is persisted with spec counts, pass rate, mean eval scores, worst features, and full event timeline. Browse past runs, compare outcomes, replay decisions.",
            ],
            [
              "Gap analysis",
            ...
            [
              "Live observability",
              "Real-time agent logs, 15 metrics dashboards, Prometheus + Grafana integration, and per-run cost rollups. Know what the system is doing and what it has done.",
            ],
            [
      ...
      <Section title="1. Design Philosophy" id="philosophy">
        ...
        <Para>
          The pipeline is decomposed into five well-defined phases. Each
      ...
      >
        ...
        <Para>
          The final phase. After reconciliation returns anything other
          than <Code>error</Code>, a second{" "}
      ...
      >
        ...
        />
        <Para>
          The Metrics tab in the UI surfaces 15 dashboards backed by{" "}
      ...
      >
        ...
        <div style={{ marginTop: 6 }}>
          Author:{" "}
          <a
            href="mailto:kquon@nvisia.com"
            style={{ color: "#58a6ff" }}
          >
            Kevin Quon &lt;kquon@nvisia.com&gt;
          </a>
        </div>
      </div>
    </div>
